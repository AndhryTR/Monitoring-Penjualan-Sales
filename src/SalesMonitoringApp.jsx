      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6 sm-fadeup">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="disp text-xl font-bold">Monitoring Penjualan by Andri.S</h1><h3 className="text-xs" style={{ color: colors.textMuted }}>by</h3><h1 className="disp text-xl font-bold" style={{ color: colors.coral }}> Andri.S</h1>
