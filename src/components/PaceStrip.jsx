...
export function PaceStrip({ timeGonePct, achPct, colors }) {
  ...
  return (
    <div className="glass-panel p-5 mb-6 sm-fadeup">
      ...
      <div className="relative h-4 rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.06)" }}>
        <div className="sm-progress-fill h-full rounded-full" style={{ width: `${capped}%`, background: `linear-gradient(90deg, ${color}99, ${color})`, boxShadow: `0 0 12px ${color}40` }} />
